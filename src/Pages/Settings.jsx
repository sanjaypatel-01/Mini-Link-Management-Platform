...
//           <button className="bg-blue-700 w-full cursor-pointer text-white rounded p-2 mt-16">
//             Save Changes
//           </button>
//           <button className="bg-red-600 w-full cursor-pointer text-white rounded p-2">
//             Delete Account
//           </button>
//         </div>
//       </div>
